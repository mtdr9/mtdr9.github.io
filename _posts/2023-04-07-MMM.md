...
8. Test the updated allocation
    1. Run a power analysis to determine the minimal amount of spend you'd need to reallocate to be 90% confident you'll observe an effect
    2. Make large enough changes to the budget and observe the effects on your dependent variable. Create a feedback loop to take learnings and reapply them to both MMM and spend
